...
public class PassportElementErrorReverseSide implements PassportElementError {
  ...
  public PassportElementErrors what() {
    return PassportElementErrors.PASSPORT_ELEMENT_ERROR_REVERSE_SIDE;
  }
  ...
  public PassportElementErrorReverseSide setType(String v) {
    this.type = v;
    return this;
  }
  ...
  public PassportElementErrorReverseSide setFileHash(String v) {
    this.fileHash = v;
    return this;
  }
  ...
  public PassportElementErrorReverseSide setMessage(String v) {
    this.message = v;
    return this;
  }
  ...
  public boolean equals(Object thatObj) {
    ...
    if (!(thatObj instanceof PassportElementErrorReverseSide)) return false;

    PassportElementErrorReverseSide that = (PassportElementErrorReverseSide) thatObj;
